...
function Poster() {
  return (
    <div className='poster'>
        ...
        <div className="button_wrapper center_center">
            <Button width={"50vw"} content={"Button1"} background_img={"/photos/Wedding18.jpg"} color='white'></Button>
            <Button width={"50vw"} content={"Button2"} background_img={"/photos/Wedding15.jpg"} color='white'></Button>
        </div>
    </div>
  )
}
